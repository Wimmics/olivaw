...
Check the [COSWOT turtle model report](./model-test-manual-NicoRobertIn-2024-12-05T15-00-47.ttl) and the [COSWOT markdown model report](./model-test-manual-NicoRobertIn-2024-12-05T15-00-47.md).